        ...
        <fieldset style="width: 1300px; height: auto;"><legend><strong>Thông tin khám bệnh</strong></legend>
            <table id="Table2" style="width:1299px; height: 185px; margin-top: 0px;">
               <tr>
                    ...
                    <td rowspan="3" style="width:100px"><asp:TextBox ID="madichvu" runat="server" Width="60"></asp:TextBox><asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/images/list.png" Width="20" Height="20" ImageAlign="Middle"/></td>
                ...
                <tr>
                    <td>Tên dịch vụ</td>
                    <td colspan="9" style="width:300px"><asp:TextBox ID="tendichvu" runat="server" Width="400px"></asp:TextBox></td>
                    <td rowspan="2" style="width:90px">
                        <asp:ImageButton ID="submitBtn" runat="server" OnClick="addService" height="50" Width="50" ImageUrl="~/images/submitBtn.png" /></td>
                    <td rowspan="2" style="width:90px">
                        <asp:ImageButton ID="cancelBtn" runat="server" OnClick="cancelService" height="50" Width="50" ImageUrl="~/images/cancel.jpg"/>
                    </td>
                    <td rowspan="2">
