...
<body style="width: 1288px; height: 85px; margin-bottom: 10px;">
    ...
    <h2 style="text-align:center;color:rgb(0, 122, 204);font-family:Verdana">Receive new patient</h2>
        <fieldset><legend><strong>Thông tin bệnh nhân</strong></legend>
        ...
        <fieldset><legend><strong>Thông tin tiếp nhận</strong></legend>
        ...
        <fieldset style="width: 1300px; height: auto;"><legend><strong>Thông tin dịch vụ</strong></legend>
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td rowspan="2" style="width:90px">
                        <asp:ImageButton ID="ImageButton4" runat="server" OnClick="newPatient" height="60" Width="60" ImageUrl="~/images/save.png" /></td>
